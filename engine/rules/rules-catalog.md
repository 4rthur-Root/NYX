...
| | |
|---|---|
| **Fichier** | `engine/rules/attack/attack/ssh_bruteforce.yaml` |
| **Type** | 1 — seuil simple |
| **Sévérité** | CRITICAL |
| **MITRE** | TA0006 / T1110 |
| **Scénario** | S1 |
...
| | |
|---|---|
| **Fichier** | `engine/rules/attack/smb_exfil.yaml` |
...
| | |
|---|---|
| **Fichier** | `engine/rules/attack/malicious_file.yaml` |
...
with open('docs/rule-schema.json') as f:
    schema = json.load(f)
with open('engine/rules/attack/nouvelle_regle.yaml') as f:
